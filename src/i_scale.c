...
static int FindNearestColor(byte* palette, int r, int g, int b)
{
	...
	{
		col = palette + i * 3;
		diff = (r - col[0]) * (r - col[0]) + (g - col[1]) * (g - col[1]) + (b - col[2]) * (b - col[2]);
...
static inline void WriteBlendedLine1x(byte* dest, byte* src1, byte* src2, byte* stretch_table)
{
	int x;
...
static inline void WriteBlendedLine2x(byte* dest, byte* src1, byte* src2, byte* stretch_table)
{
	int x;
	int val;
...
static inline void WriteBlendedLine3x(byte* dest, byte* src1, byte* src2, byte* stretch_table)
{
	int x;
	int val;
...
static inline void WriteBlendedLine4x(byte* dest, byte* src1, byte* src2, byte* stretch_table)
{
	int x;
	int val;
