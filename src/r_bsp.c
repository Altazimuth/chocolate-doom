...
void R_Subsector(int num)
{
	...
	{
		floorplane = R_FindPlane(frontsector->floorheight, frontsector->floorpic, frontsector->lightlevel, frontsector, sub);
	}
	else
		floorplane = NULL;
	...
	{
		ceilingplane = R_FindPlane(frontsector->ceilingheight, frontsector->ceilingpic, frontsector->lightlevel, frontsector, sub);
	}
	else
		ceilingplane = NULL;
