...
static void OtherKeysDialog(TXT_UNCAST_ARG(widget), TXT_UNCAST_ARG(unused))
{
	...
	TXT_AddWidgets(table, TXT_NewLabel(" - Weapons - "), TXT_NewStrut(0, 0), NULL);
	...
	TXT_AddWidgets(table, TXT_NewStrut(0, 1), TXT_NewStrut(0, 1), TXT_NewLabel(" - Menu navigation - "), TXT_NewStrut(0, 0), NULL);
	...
	TXT_AddWidgets(table, TXT_NewStrut(0, 1), TXT_NewStrut(0, 1), TXT_NewLabel(" - Shortcut keys - "), TXT_NewStrut(0, 0), NULL);
	...
	TXT_AddWidgets(table, TXT_NewStrut(0, 1), TXT_NewStrut(0, 1), TXT_NewLabel(" - Multiplayer - "), TXT_NewStrut(0, 0), NULL);
	...
	TXT_AddWidgets(table, TXT_NewStrut(0, 1), TXT_NewStrut(0, 1), TXT_NewLabel(" - Map - "), TXT_NewStrut(0, 0), NULL);
...
void ConfigKeyboard(void)
{
	...
	TXT_AddWidgets(window,
	               ...
	               TXT_NewSeparator("Action"), action_table = TXT_NewTable(4), TXT_NewButton2("Other keys...", OtherKeysDialog, NULL), NULL);
	               
	TXT_AddWidgets(window,
	               TXT_NewSeparator("Misc."),
	               run_control = TXT_NewCheckBox("Always run", &always_run),
	               TXT_NewInvertedCheckBox("Use native keyboard mapping", &vanilla_keyboard_mapping), NULL);
